package com.shaneoosthuizen.assessment.clonedstackoverflow.components.questiondetailscomponent.data.question.models
...
data class QuestionDetailsResponse(@SerializedName("items") val items: List<QuestionData>)
